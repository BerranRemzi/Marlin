...
#define STRING_CONFIG_H_AUTHOR "(Custom Config)" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 50, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
